...
/**
  ...
  */
object BehindTheNameFirstSubmittedScraper {
  private val logger = LoggerFactory.getLogger(this.getClass)

  private val urlBase = Uri("https://www.behindthename.com/submit/names/letter/")
  ...
  def main(args : Array[String]): Unit = {
    ...
    val instruction1 = MaeveInstruction("behindthenameFirstSub", target, actions, filter, "./data/web/behindthename/", isHeadless = true, recovEnabled = true)
    ...
    val instruction2 = MaeveInstruction("behindthenameFirstnamesSub", target2, actions, filter2, "./data/web/behindthename/", isHeadless = true, recovEnabled = true)

    scraper.feedInstruction(instruction2)
    scraper.scrapeUsingCurrInstruction()
    urlFiles.foreach(_.delete())

    ZipperUtil.zip(new File("./data/web/babynamewizard/behindthenameFirstnamesSub.csv"),new File("./archives/web/behindthename/"))
  }
}
